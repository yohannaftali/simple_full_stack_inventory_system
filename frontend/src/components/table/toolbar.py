...
class TableToolbar:
    ...
    def add_button(self, position, callback, icon=ft.Icons.ABC, tooltip="", icon_color=ft.Colors.ON_PRIMARY_CONTAINER):
        """Return an button"""
    ...
    def add_new_button(self, callback, icon=ft.Icons.ADD, tooltip="Add New", icon_color=ft.Colors.ON_PRIMARY_CONTAINER):
    ...
    def add_save_button(self, callback, icon=ft.Icons.SAVE, tooltip="Save", icon_color=ft.Colors.ON_PRIMARY_CONTAINER):
